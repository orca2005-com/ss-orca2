/*
  # Fix Triggers and Functions Migration
...
BEGIN
  ...
  -- Insert into user_profiles table with default stats
  INSERT INTO user_profiles (user_id, stats)
  VALUES (NEW.id, '{"followers": 0, "following": 0, "posts": 0}')
...
-- Function to create notifications on follows
...
-- Function to create notifications on likes
...
-- Function to create notifications on comments
...
-- Function to create notifications on messages
